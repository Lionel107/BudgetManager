...
val appModule = module {
    ...
    single { com.budgetmanager.data.repository.LocalImportRepository(get(), get(), get(), get(), get()) }
    single { com.budgetmanager.data.repository.PlannerRepository(get(), get(), get(), get(), get()) }
